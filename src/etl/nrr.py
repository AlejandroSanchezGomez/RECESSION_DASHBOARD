...
class NRR_VALUE:
    ...
    def list_unify(self):
        ...
        n = 0
        for elem in list_df: # iterates the list and then performs left join in the previous stored dataframe of the iteration.
            if(n==0):
                table = elem
            else:
    ...
    def upload_nrr_azure(self):
        ...
        blob_client = blob_service_client.get_blob_client(container = "container-nrr", blob = "nrr_table") # create the "nrr_table" blob in the "container-nrr" container which will store the RRL timeserie.
